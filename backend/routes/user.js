...
const { getprofile, editprofile, updatelocation, addFriends, getFriends, getNearestUsers, getFollowUsers, getAllUsers, addEmergencyContacts, incUserPoints, deductPoints } = require("../controllers/user.js");
// import controller
...
router.post("/incUserPoints/:userId", incUserPoints);
router.post("/deductPoints/:userId", deductPoints);

...
class Otp extends React.Component{
    ...
    render () {
      ...
      const handleCodeVerify = () => {
        ...
        if(otp1===otp2){
          ...
          if(this.props.route.params.isSignUp){
            console.log("okkk")
            axios.post(`${ENV.apiUrl}/auth/register`,{
          ...
          console.log("ok1")
          axios.post(`${ENV.apiUrl}/auth/login`,{
            email: this.props.route.params.email,
            password: this.props.route.params.password,
        })
        .then((response) => {
      ...
      // renderHome
        return (
            <Block flex middle>
        <Text bold style={styles.text} size={24}>Enter OTP password</Text>
        ...
        />
            ...
            <Block middle>
              ...
              <Text bold size={20} color={argonTheme.COLORS.PRIMARY}>Verify</Text>
            </TouchableOpacity>
                    </Block>
      </Block>
        )
